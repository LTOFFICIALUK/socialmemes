-- Complete platform revenue data population script
-- This script populates both featured_tokens and pro_subscriptions tables
-- with sample data for the current period (2025-10-01 to 2025-10-14)
-- 
-- IMPORTANT: Run create-test-profiles.sql first to ensure enough profiles exist!
...
BEGIN
    ...
    IF profile_count < 25 THEN
        RAISE EXCEPTION 'Not enough profiles found. Please run create-test-profiles.sql first. Found: %, Need: 25', profile_count;
    END IF;
    
    RAISE NOTICE 'Found % profiles. Proceeding with data population.', profile_count;
END $$;
