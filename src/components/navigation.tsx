...
import { Home, Grid3X3, User, LogOut, Settings, Bell, Search, BookOpen, Plus, TrendingUp, Users, Crown, HelpCircle } from 'lucide-react'
...
export const Navigation = ({ currentUser, onSignOut, onPromoteClick, onProClick }: NavigationProps) => {
  ...
  return (
    <nav className="h-full w-full bg-black flex flex-col">
      {/* Logo */}
      <div className="pt-6 pr-6 pl-7 pb-8">
